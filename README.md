...
> ❗ **This instrumentation is no longer recommend**. Please review [documentation on setting up and configuring the OpenTelemetry Java SDK and APIs](https://github.com/open-telemetry/opentelemetry-java) for more information on migrating to OpenTelemetry.
